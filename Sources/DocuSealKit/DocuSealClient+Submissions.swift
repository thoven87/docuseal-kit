...
extension DocuSealClient {
  ...
  public func listSubmissions(query: SubmissionListQuery? = nil) async throws
  ...
  public func createSubmissionsFromEmails(request: CreateSubmissionsFromEmailsRequest) async throws
    -> [Submitter]
  {
